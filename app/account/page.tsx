...
import { signAuditToken, verifyAuditToken } from "@/lib/audit-token";
      ...
      <div style={s.topbar}>
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <form action="/api/account/signout" method="POST">
            <button
              type="submit"
              style={{ fontSize: 11, letterSpacing: 1.4, textTransform: "uppercase" as const, color: "var(--color-text-muted)", background: "none", border: "none", cursor: "pointer", padding: 0 }}
            >
              Sign out
            </button>
          </form>
