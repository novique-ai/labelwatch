...
function normalizeIngredientName(s: string): string {
  return s
    ...
    .replace(/\bflavourings?\b/g, "flavor")
    .replace(/\bflavor\b/g, "flavor")
    .replace(/\bflavorings?\b/g, "flavor")
    .replace(/\bsodium chloride\b/g, "salt")
    .replace(/\bgluten\b/g, "wheat")
    .replace(/\bvegetable fats?\b/g, "palm oil")
    ...
    .replace(/\bhydrolyzed whey protein isolate\b/g, "whey protein")
    .replace(/\bwhey protein isolate\b/g, "whey protein")
    .replace(/\bwhey protein concentrate\b/g, "whey protein")
