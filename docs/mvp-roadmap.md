...
| **v0.0.2: Pro/Team tier feature delivery (EPIC)** | `infrastructure-azn9` | 🟡 2/9 sub-beads shipped (0a0x, gvqx); product-delivers-gate compliance for Pro/Team |
| ↳ Tier brand cap (firm_aliases count) | `infrastructure-0a0x` | ✅ Shipped 2026-05-06 (Starter 1 / Pro 5 / Team unlimited) |
| ↳ Tier channel cap + type allowlist | `infrastructure-gvqx` | 🟡 Code landed 2026-05-06; staging-first promotion (Starter 1ch email+slack / Pro 3ch all 4 types / Team unlimited) |
