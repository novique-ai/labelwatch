...
| **v0.0.2: Pro/Team tier feature delivery (EPIC)** | `infrastructure-azn9` | 🟡 3/9 sub-beads shipped (0a0x, gvqx, fovp); product-delivers-gate compliance for Pro/Team |
...
| ↳ Tier history window cap | `infrastructure-fovp` | 🟡 Code landed 2026-05-06; staging-first promotion (Starter 7d / Pro 12mo / Team unlimited) |
