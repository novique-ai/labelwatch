...
Last run: `fbd011e4-96e5-47a8-8423-91a1a7173249` (2026-05-09) — **RED**. 33/64 pass, 3 fail (all expected: exje in_progress), 10 anomaly, 18 skip. Run file: `infra/scripts/shell-corp/qa/runs/labelwatch-fbd011e4-96e5-47a8-8423-91a1a7173249.json`.

**Promotion gate:** QA must return GREEN before any merge to `main`. The only acceptable skip reasons are cases blocked by an explicitly in_progress bead (currently: all Pro/Team cases blocked by `infrastructure-exje`).
